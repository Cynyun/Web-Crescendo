<template>
  <div class="framework">
    <div class="header">
      <div class="nav-tabs">
        <button class="tab-button" @click="handleClick('yjworld')">世界观</button>
        <button class="tab-button" @click="handleClick('yjperson')">人物志</button>
      </div>
    </div>
    <div class="container">
...
const handleClick = (str: string) => {
  if (str === 'yjworld') {
    router.push('YJWorld')
  } else if (str === 'yjperson') {
    router.push('YJPerson')
  }
}

// 轮播图片配置（明确5张图，避免路径混乱）
const carouselImages = ref([
  { src: '/Images/YJImages/ct1.jpg', alt: '轮播图1' },
  { src: '/Images/YJImages/ct2.jpg', alt: '轮播图2' },
  { src: '/Images/YJImages/ct3.jpg', alt: '轮播图3' },
  { src: '/Images/YJImages/ct4.jpg', alt: '轮播图4' },
  { src: '/Images/YJImages/ct5.jpg', alt: '轮播图5' }
])
...
.header {
  ...
  background-image:
    ...
    url('/Images/YJImages/headerimage.webp'),
    url('/Images/YJImages/hengfu.webp');
...
.container {
  ...
  color: white;
  background-image: url('/Images/YJImages/backgroundImage1.webp');
