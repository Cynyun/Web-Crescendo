<template>
  <div class="page-container">
    ...
    <div class="split-container">
      <!-- 左侧：动态背景图区域 -->
      <div class="left-panel" :style="{ backgroundImage: `url(${leftImageLists[activeIndex]?.url})` }">
        <!-- 装饰性遮罩层 -->
        <div class="left-mask"></div>
        <!-- 英雄名称标题（行楷字体） -->
        <GradientText :text="buttonList[activeIndex]?.name || ''" tag="h1" :fontSize="48" :fontWeight="500"
          lineHeight="normal" gradientColors="#ffffff, #e0e0e0" position="relative" left="auto" marginLeft="0"
          class="person-title" />
        <!-- 装饰性边框 -->
      ...
      <div class="right-panel">
        ...
        <div class="image-card">
          <div class="image-wrapper">
            <img :src="rightImageLists[activeIndex]?.url" :alt="buttonList[activeIndex]?.name" class="hero-image"
              loading="lazy">
          </div>
        </div>
      </div>
...
// 左侧背景图列表（public/Images/YJImages下的图片，路径以/Images/YJImages/开头）
const leftImageLists = ref([
  { url: '/Images/YJImages/wc1.jpg' },
  { url: '/Images/YJImages/ys1.jpg' },
  { url: '/Images/YJImages/jch1.jpg' },
  { url: '/Images/YJImages/th1.jpg' },
  { url: '/Images/YJImages/nhy1.jpg' },
  { url: '/Images/YJImages/liul1.jpg' },
  { url: '/Images/YJImages/hd1.jpg' },
  { url: '/Images/YJImages/hw1.jpg' },
])

// 右侧展示图列表（public/Images/YJImages下的图片，路径以/Images/YJImages/开头）
const rightImageLists = ref([
  { url: '/Images/YJImages/wc.png' },
  { url: '/Images/YJImages/ys.png' },
  { url: '/Images/YJImages/jch.png' },
  { url: '/Images/YJImages/th.png' },
  { url: '/Images/YJImages/nhy.png' },
  { url: '/Images/YJImages/liul.png' },
  { url: '/Images/YJImages/hd.png' },
  { url: '/Images/YJImages/hw.png' },
]);
...
.header {
  ...
  position: relative;
  background:
    url('/Images/YJImages/logo.png') no-repeat 40px 15px / contain,
